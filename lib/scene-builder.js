...
class SceneBuilder extends NodeBuilderBase {
    ...
    addChildNode(parentName, childName, opts = {}) {
        ...
        const childUITransform = uitransformTemplate(childIdx, -1, size[0], size[1], true);
